...
<div class="container">
    <div class="row-fluid">
        <p>This Privacy Policy governs the manner in which TravelWid.Me collects, uses, maintains and discloses information collected from users (each, a "User") of the www.travelwid.me website ("Site"). This privacy policy applies to the Site and all products and services offered by TravelWid.Me.</p><br/>
        ...
        <p>TravelWid.Me may collect and use Users personal information for the following purposes:</p><br/>
        ...
        <p>Our Site is in compliance with PCI vulnerability standards in order to create as secure of an environment as possible for Users.</p><br/>
